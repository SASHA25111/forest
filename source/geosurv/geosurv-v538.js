/* ФАЙЛ: geosurv-v538.js — GEOsurvivor логика (v5.38)
...
(function(){
  ...
  function spawnPhantom(){
    ...
    var hpScale = getHpScale();
    var scaledHp = Math.ceil(def.hp * hpScale * 0.85);
  ...
  function spawnSentinel(){
    var def = ENEMY_TYPES.mega;
    var hpScale = getHpScale();
    var scaledHp = Math.ceil(def.hp * hpScale * 0.9);
    var damageMul = getMegaDamageMul(state.megaCount);
    var p = state.player;
    var ang = Math.random() * Math.PI*2;
  ...
  function spawnPainter(){
    var def = ENEMY_TYPES.mega;
    var hpScale = getHpScale();
    var scaledHp = Math.ceil(def.hp * hpScale * 0.75);
    var damageMul = getMegaDamageMul(state.megaCount);
    var p = state.player;
    var ang = Math.random() * Math.PI*2;
    state.enemies.push({
  ...
  function spawnTwins(){
    ...
    var scaledHp = Math.ceil(def.hp * hpScale * 1.5);
    // v5.29: damageMul по таблице
    var damageMul = getMegaDamageMul(state.megaCount);
