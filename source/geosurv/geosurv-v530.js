(function(){
  ...
  // v5.29: жёсткое расписание мега-боссов (после 12-го — +2 мин на каждого)
  var MEGA_TIMES = [180, 360, 540, 660, 780, 900, 1020, 1140, 1260, 1380, 1440, 1560];
  function megaScheduleTime(n){
    if (n < MEGA_TIMES.length) return MEGA_TIMES[n];
    return MEGA_TIMES[MEGA_TIMES.length - 1] + 120 * (n - MEGA_TIMES.length + 1);
  }
  ...
  function renderLB(list){
    ...
    list.slice(0, 7).forEach(function(row, i){
      ...
      // v5.30: показываем time и level вместо score
